...
transcripts_dir = r'd:\OneDrive\Notes\deeplearning.ai\Claude Code A Highly Agentic Coding Assistant\Transcripts'
files = [f for f in os.listdir(transcripts_dir) if f != 'format.py' and (f.endswith('.txt') or '.' not in f)]

...
- you can use the Pro or Max [subscription](<https://www.anthropic.com/claude-code#:~:text=Pro,Sign> up). The pro subscription is enough for the lessons' activities.
